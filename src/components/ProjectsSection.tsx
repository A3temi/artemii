...
// put this near your variant definitions
// cast the numeric cubic-bezier array to Easing to satisfy TS
const professionalEasing = [0.25, 0.46, 0.45, 0.94] as unknown as Easing;

/* containerVariants typed explicitly */
...
/* projectItemVariants must be typed Variants because visible is a function (custom resolver) */
